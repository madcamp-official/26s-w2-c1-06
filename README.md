...
- **시연 영상 / 이미지:**
  ...
  <p>
    <img src="docs/images/overview.png" alt="프로젝트 개요 — 구조도·진행 현황" width="32%" />
    <img src="docs/images/difficulty-setup.png" alt="난이도 설정 — 수강 과목 기반 설명 수준 맞춤" width="32%" />
    <img src="docs/images/session-summary.png" alt="세션 활동 요약 — 구조 변경과 정리된 변경사항" width="32%" />
  </p>
...
- macOS (Apple Silicon): [Factcoding-0.1.0-arm64.dmg](https://github.com/madcamp-official/26s-w2-c1-06/releases/download/v0.1.0-build.4/Factcoding-0.1.0-arm64.dmg)
- Windows: [Factcoding.Setup.0.1.0.exe](https://github.com/madcamp-official/26s-w2-c1-06/releases/download/v0.1.0-build.4/Factcoding.Setup.0.1.0.exe)
